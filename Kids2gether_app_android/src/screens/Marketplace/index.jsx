...
export default function Marketplace() {
  ...
  const getData = async () => {
    ...
    try {
      ...
      setAwaitLoading(false);
      setLoading(false);
      Alert.alert("", "Erro ao carregar marketplace");
    }
  };
  ...
  /*   const marketplace = [
    {
      name: 'Karmita Medeiros',
      whatsapp: 'https://bit.ly/Karmita '
    },
    {
      name: "Lidia Cristina Ribeiro",
      whatsapp: "https://bit.ly/3RBV4lN"
    },
    {
      name: "Joana D`arc",
      whatsapp: "https://bit.ly/3x3Zbjq"
    },
    {
      name: 'Juninho França',
      whatsapp: 'https://bit.ly/3V8TSXO'
    },
    {
      name: 'Fernanda Bike',
      whatsapp: 'https://bit.ly/3KPz82N'
    },
    {
      name: 'Gilmara Santana',
      whatsapp: 'https://bit.ly/MaraBabá'
    }
  ];
 */
